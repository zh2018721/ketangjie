<template>
  <div class="hello">
      <div class="course-list-container">
          <div class="course-item" :class="i > 0 && 'line line-top'" v-for="(item,i) in list" :key="i" @click="open(item.courseid)">
                <div class="logo-con">
                  <div class="logo">  
                      <img :src="item.defaultpic" />
                      <span class="is-relay">转载</span>
                  </div>
                </div>
                <div class="main-con">
...
.course-item .logo-con .logo {
 ...
 .course-item .logo-con .logo img {
    width: 120px;
}
 .course-item .logo-con .is-relay {
    position: absolute;
    bottom: 0;
    right: 0;
    color: #fff;
    ...
    -webkit-border-radius: 0 0 .053333rem 0;
    border-radius: 0 0 .053333rem 0;
    padding: .093333rem;
}
 .course-item .logo-con .is-relay {
    font-size: 11px;
}
 .course-item .main-con {
    padding-top: 18px;
    -webkit-box-flex: 1;
    -webkit-flex-grow: 1;
    -moz-box-flex: 1;
 ...
 .course-item .main-con .course-name {
    margin-bottom: 21px;
    display: -webkit-box;
    display: -webkit-flex;
    display: -moz-box;
 ...
 .course-item .main-con .course-name .left .title {
    font-weight: 700;
    line-height: 1.4;
    display: -webkit-box;
 ...
 .course-item .main-con .last-con .learning-num {
    display: -webkit-box;
    display: -webkit-flex;
    display: -moz-box;
    display: flex;
 ...
 .course-item .main-con .last-con .charge {
    display: -webkit-box;
    display: -webkit-flex;
    display: -moz-box;
    display: flex;
